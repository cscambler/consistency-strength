...
\begin{proof}
    ...
    Suppose $Univ(d)$. Going left to right, suppose
    ...
    Hence $\Diamond \varphi$. Going right to left,
    ...
    I claim $\Diamond (\varphi \wedge Univ(e))$. It is obvious that 
    $\Diamond (\varphi \wedge \forall y[y \in e])$. And $z \in e$ implies $Xe$ which 
    implies $\Diamond (\varphi \wedge Univ(e) \wedge Ee)$. Hence $\Diamond (\varphi \wedge Univ(e))$.
    By the IH, $\Diamond (\varphi \wedge ((\varphi(e)_\exists)^\Diamond \equiv \varphi))$.
    Hence $\Diamond (\varphi(e)_\exists)^\Diamond$. And moreover it is not hard to argue 
    $Tran(e)$. Hence 
