...
of our first order logic. The guiding thought, ultimately, will be to interpret 
...
every universal). However in our setting this won't quite be enough. We may need to add a $\Diamond$ 
in front of every atomic formula CHECK. But we will actually need to be a bit clever with variables, in ways
(and for reasons) I will get to momentarily. 
