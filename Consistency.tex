...
\begin{proof}
    ...
    The plural rigidity axioms are completely trivial. For plural comprehension 
    we can use separation in $L[r]$; note that this only works because we restrict ourselves 
    to parameters in $L[r]$ (i.e. closed form). Without this it fails.
