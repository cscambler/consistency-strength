...
We know $\omega_1^{L[r]} \text{ exists}^{\du}$. That means it is vertically 
possible that there is an ordinal in $L[r]$ such that it is vertically necessary 
that no function in $L[r]$ is a bijection between that ordinal and $\omega$.
Suppose that same ordinal is not the $\omega_1$ of $L[r]$ in the sense of $\Diamond$.
Then it is generally possible that there is a function in $L[r]_\alpha$ for some 
$\alpha$ that \emph{is} a bijection between that ordinal and $\omega$. Since
it is vertically possible that $\alpha$ exists, and 
$L[r]_\alpha^\Diamond = L[r]_\alpha^{\du}$, we must have the $\du$-translation 
of $f$ exists and belongs to $L[r]_\alpha$. And of course being a bijection between 
the ordinal and $\omega$ is $\Delta_0$ and so absolute. Hence the ordinal in question
was not $\omega_1^L[r]$ in the sense of $\du$.
