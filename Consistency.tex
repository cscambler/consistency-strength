...
So then we can prove that being the $\omega_1$ of $L[r]$ is absolute between the two modalities.
For if $x$ is $< \omega_1$ of $L[r]$ according to $\Diamond$, then we can 
find an $L[r]_\alpha$ in the sense of $\Diamond$ that has a bijection betwen $x$ and $\omega$.
But being the $L[r]_\alpha$ according to $\Diamond$ is the same as being the $L[r]_\alpha$ 
according to $\du$. So there is an $L[r]_\alpha$ according to $\du$ which contains such 
a bijection.
