...
The correlated first order set theory will be $\mathsf{ZFC}^- + \mathsf{V = HC}$
together with the $\Pi^1_1$ perfect set property. 

Define perfect set property: $r \subseteq \omega^\omega$ is perfect iff it is 
the set of paths through a perfect tree on $\omega \times \omega$.
